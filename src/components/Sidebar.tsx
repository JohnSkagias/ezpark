    ...
    <aside className="h-full p-5 text-white">
      <div className="flex flex-col h-full justify-between">
        <div className="space-y-4">
          ...
          <div className="relative rounded-full bg-white/10 p-2 mt-[clamp(1.5rem,6vh,5rem)] overflow-hidden">
            ...
            <div className="relative grid grid-cols-2">
              <button
                ...
                className="z-10 px-4 py-3 text-sm font-medium text-white whitespace-nowrap flex items-center justify-center"
          ...
          {/* Κουμπιά scope - segmented control with sliding indicator */}
