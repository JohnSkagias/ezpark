...
export const metadata: Metadata = {
  ...
  description:
    "Το EzPark σε βοηθά να βρίσκεις ‘φιλικούς’ δρόμους στάθμευσης στην Αθήνα και στα προάστια, με χάρτη και έξυπνη λίστα.",
  alternates: {
    canonical: "/",
  },
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Βρες ‘φιλικούς’ δρόμους στάθμευσης στην Αθήνα και στα προάστια – με χάρτη και λίστα.",
    images: [
      {
        url: "/og.png",
        width: 1200,
